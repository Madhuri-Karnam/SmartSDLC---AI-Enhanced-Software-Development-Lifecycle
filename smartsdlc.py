...
Original file is located at
    https://colab.research.google.com/drive/1m8bQy1GDC1F4k2aLwKzqKYLpiVXaQKo7
"""

# Install core libraries for FastAPI and Uvicorn
!pip install fastapi uvicorn python-multipart

# Install libraries for AI models and PDF processing
!pip install pymupdf  # PyMuPDF is the library for PDF
!pip install transformers accelerate torch  # For Hugging Face models

# Install both langchain and langchain-community explicitly
!pip install langchain
!pip install langchain-community
!pip install -U bitsandbytes

# Install ngrok for exposing the Colab server
!pip install pyngrok

# Clear output for a cleaner notebook
...
import os
HUGGING_FACE_TOKEN = os.getenv("HUGGING_FACE_TOKEN", "your_fallback_token_if_not_set")
# You would then set this environment variable in your Colab notebook
# import os
# os.environ["HUGGING_FACE_TOKEN"] = "hf_YOUR_ACTUAL_TOKEN_HERE"


# Commented out IPython magic to ensure Python compatibility.
# %%writefile main.py
# # This magic command writes the content of this cell to a file named main.py
# 
...
# Kill any existing ngrok tunnels BEFORE attempting to connect
print("Attempting to kill existing ngrok tunnels...")
ngrok.kill()
time.sleep(2) # Give it a moment to ensure processes are terminated
print("Existing ngrok tunnels killed (if any).")

# IMPORTANT: Replace "YOUR_NGROK_AUTH_TOKEN_YOU_COPIED_HERE" with your actual token
# This line should already be uncommented and contain your token from the previous step
ngrok.set_auth_token("2yzPXqqw2YCfvkX5L2yBvSOMHbT_2ejEdmswXJsEAAiWF4bY9")

try:
    # Start the ngrok tunnel. Default port for uvicorn is 8000.
    public_url = ngrok.connect(8000)
    print(f"Public URL for FastAPI: {public_url}")

    # Run Uvicorn in the background. main:app refers to the 'app' object in 'main.py'
    # Use allow_origins="*" in main.py for development
    # Note: The & runs it in the background, so Colab continues executing.
    # This print will appear before the Uvicorn logs start.
    print("Starting Uvicorn server...")
    !uvicorn main:app --host 0.0.0.0 --port 8000 &

except Exception as e:
    print(f"Failed to start ngrok tunnel: {e}")
    print("Please check your ngrok dashboard (https://dashboard.ngrok.com/agents/active) and disconnect any active sessions.")
    print("Also ensure your ngrok authtoken is correctly set in this cell.")